...
public class WebService {
	...
	public WebService(String name, List<String> urlFragments, HashMap<String, String> prefixes, ArrayList<String> headVariables, HashMap<String, Integer> headVariableToPosition, int numberInputs,  int numberOutputs){
		this.name = name;
		...
		this.numberOfOutputs = numberOutputs;
	...
	public String getURLForCallWithInputs(String... inputs){
		...
		for(String p:urlFragments){
			if(p == null){
				...
				call.append((inputs[i].trim().replaceAll("\\s+","+")));
			}
			else call.append(p);
		}
